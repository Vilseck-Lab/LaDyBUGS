...
# Lambda Dynamics with Bias Updated Gibbs Sampling + FastMBAR in OpenMM
...
## LaDyBUGS sampling parameters  (This example will run for 5 ns)
...
numBiasLoops = 25          ## number of bias updates with FastMBAR (occurs every numCycle steps)
...
exp_mult = 1
exp_start = 1      ## the first numBiasLoops update (0-ordered) where exp_biasing is used  
